...
//        [self addChild:background];
        ...
        SKSpriteNode *background = [SKSpriteNode spriteNodeWithImageNamed:@"cobblestone.jpg"];
        background.position = CGPointMake(self.frame.size.width/2, self.frame.size.height/2);
        [self addChild:background];


        SKLightNode *light = [[SKLightNode alloc]init];
//        [light setLightColor:[UIColor yellowColor]];
//        [light setPosition:CGPointMake(self.frame.size.width/2, self.frame.size.height/2)];
...
-(void)touchesBegan:(NSSet*)touches withEvent:(UIEvent*)event {
    ...
    NSLog(@"Body name: %@", body.node.name);
